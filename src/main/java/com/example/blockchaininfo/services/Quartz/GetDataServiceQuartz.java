...
public class GetDataServiceQuartz{
    ...
    public GetDataServiceQuartz(NetworkHashrateRepository networkHashrateRepository, PoolDefRepository poolDefRepository, PoolHashrateRepository poolHashrateRepository, ObjectMapper jsonMapper) {
